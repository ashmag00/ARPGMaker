...
module = Extension('ARPGMaker',
                   sources = ['extend.cpp', 'engine/render.cpp', 'engine/Entity.cpp', 'engine/inputs.cpp', 'engine/main.cpp', 'engine/Map.cpp', 'engine/Music.cpp', 'engine/Sound.cpp', 'engine/Tile.cpp'],
